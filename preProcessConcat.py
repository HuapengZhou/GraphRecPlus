...
def preprocess_data(ratings, edges):
    ...
    history_u_lists, history_ur_lists, history_v_lists, history_vr_lists, history_vc_lists = generate_history(ratings)
    ...
    return history_u_lists, history_ur_lists, history_v_lists, history_vr_lists, history_vc_lists, \
...
def generate_history(ratings):
    ...
    Returns
    -------
    history_u_lists, history_ur_lists, history_v_lists, history_vr_lists, history_vc_lists : dict
        User purchase history and rating history.
    """
...
history_u_lists, history_ur_lists, history_v_lists, history_vr_lists, history_vc_lists, \
train_u, train_v, train_r, test_u, test_v, test_r, social_adj_lists = preprocess_data(ratings, edges)

# Save the data to a pickle file
data = (history_u_lists, history_ur_lists, history_v_lists, history_vr_lists, history_vc_lists,
        train_u, train_v, train_r, test_u, test_v, test_r, social_adj_lists, ratings_list)

save_to_pickle('./data/Ciao80_with_cat.pickle', data)
